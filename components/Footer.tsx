...
const Footer = () => {
    return (
        <footer className="flex flex-col gap-14 items-center max-sm:px-7 my-10 border-t-[1px] border-gray-800">
            <div className="flex justify-between w-full mt-8 px-14 max-sm:mt-4">
            ...
            <div className="flex justify-between w-full pt-8 px-8 items-end border-t-[1px] border-gray-800">
