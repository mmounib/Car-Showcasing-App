...
const Card = ({ cars, key }: cardObjects) => {
  ...
  return (
    <div
      key={key}
      className="bg-gray-800 rounded-[10px] hover:bg-gray-700 ease duration-300 group"
    >
      <div className="m-6 flex flex-col gap-6 max-sm:gap-4">
        ...
        <span className="font-bold text-2xl text-gray-300">
          <sup className="">$</sup>
          {carRent}
          <sub className="text-xs font-extralight">/day</sub>
        </span>
